(()=>{
  ...
  function install(){
    ...
    st.textContent=`
      ...
      @media(max-width:700px){header{column-gap:6px!important}.sfBackToHub{min-height:32px;padding:6px 8px;font-size:11px;border-radius:10px}header .sub,header small{display:none!important}}
